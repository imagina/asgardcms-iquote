...
class CacheCharacteristicDecorator extends BaseCacheDecorator implements CharacteristicRepository
{
    public function __construct(CharacteristicRepository $characteristic)
    {
      parent::__construct();
      $this->entityName = 'iquote.characteristics';
      $this->repository = $characteristic;
    }
