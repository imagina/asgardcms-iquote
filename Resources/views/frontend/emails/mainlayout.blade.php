...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    ...
    <body style="background: #D1D2DD;">
        <div class="mj-container" style="background-color:#D1D2DD;">
            ...
            <![endif]-->
            <div style="margin:0px auto;max-width:100%;background:#FEFEFF;">
                <table role="presentation" cellpadding="0" cellspacing="0" style="font-size:0px;width:80%;background:#FEFEFF;" align="center" border="0">
                    <tbody>
                    <tr>
                                    ...
                                    <tr>
                                        <td style="word-wrap:break-word;font-size:0px;padding:0px 0px 0px 0px;" align="center">
                                            <div style="cursor:auto;color:#000000;font-family:Ubuntu, sans-serif;font-size:11px;line-height:1.5;text-align:center;">
                                                <p><strong><span style="font-size:36px;">{{ setting('core::site-name') }} - Detalle de su Cotización</span></strong></p>
                                            </div>
                                        </td>
                                    </tr>
                                    </tbody>
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" align="center" style="width:100%;">
                <tr>
                    <td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;">
            <![endif]-->
            <div style="margin:0px auto;max-width:100%;background:{{ setting('isite::brandPrimary') }}  url('{{ setting('isite::logo1') }}') top center / auto repeat;">
                <!--[if mso | IE]>
                <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:100%;">
                    <v:fill origin="0.5, 0" position="0.5,0" type="tile" src="https://storage.googleapis.com/afuxova10642/pc3.png" />
                    <v:textbox style="mso-fit-shape-to-text:true" inset="0,0,0,0">
                <![endif]-->
                <table role="presentation" cellpadding="0" cellspacing="0" style="font-size:0px;width:100%;background: {{ setting('isite::brandPrimary') }} url('{{ setting('isite::logo1') }}') center no-repeat;" align="center" border="0" background="{{ setting('isite::logo1') }}">
                    <tbody>
                    <tr>
                        <td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:0px 0px 0px 0px;">
                            <!--[if mso | IE]>
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="vertical-align:top;width:100%;">
                            <![endif]-->
                            <div class="mj-column-per-100 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:100px;text-align:left;width:100%;">
                                &nbsp;
                            </div>
                            <!--[if mso | IE]>
                            </td>
                        ...
                        <td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:9px 0px 9px 0px;">
                            ...
                            <div class="mj-column-per-100 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%;">
                                <table role="presentation" cellpadding="0" cellspacing="0" style="vertical-align:top;" width="100%" border="0">
                                    <tbody>
                                    <tr>
                                        <td style="word-wrap:break-word;font-size:20px;padding:0px 0px 0px 0px;color: #2E2A2A" align="center">
                                            <div>
